        ...
        if connection.is_connected():
            ...
            with open('../Pandas/ADTV_TSLA.csv', 'r') as file:
                ...
                for row in csv_reader:
                    ...
                    sql = """
                        INSERT INTO dati (date, open, high, low, close, adj_close, volume, ADTV_2, ADTV_2_std, ADTV_5, ADTV_5_std, ADTV_10, ADTV_10_std, ADTV_20, ADTV_20_std, ADTV_50, ADTV_50_std, MFM, CMF)
...
def insert_csv_iniziale_to_db(csv_file):
    try:
        # Creazione connessione
        connection = mysql.connector.connect(
            host="localhost",
        ...
        if connection.is_connected():
            ...
            with open('../Pandas/updated_data.csv', 'r') as file:
                ...
                for row in csv_reader:
                    # Inserisci i dati nella tabella
                    sql = """
                        INSERT INTO dati_iniziali (date, open, high, low, close, adj_close, volume) VALUES (%s, %s, %s, %s, %s, %s, %s)
                    """
                    cursor.execute(sql, row)
...
# Chiamata alla funzione con il nome del CSV
insert_csv_iniziale_to_db("../Pandas/updated_data.csv")
